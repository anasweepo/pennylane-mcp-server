...
function registerListedPennylaneEndpoints() {
  const endpoints = [
    ...
    { name: "pl_doc_updatecategory", title: "Catégories · Updates a category", description: "Update a category Jump to Content Home Guides API Reference Changelog Discussions ⚪ API Status v1.0 v2.0 Log In API Reference Log In v2.0 Home Guides API Reference Changelog Discussions ⚪ API Status Update a category JUM", method: "PUT", path: "/categories/{id}", hasPathParams: true, hasQuery: true, hasBody: true },
